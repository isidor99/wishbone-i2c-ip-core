...
| **addr_i**          | in  | std_logic_vector (2 downto 0)             | Adresa registra sa kojim se ostvaruje komunikacija. Širina ovog podatka zavisi od ukupnog broja registra. Ovaj dizajn ima osam registara.                                                                          |
...
| **rd_slv_o**        | out | std_logic                                 | Komandni signal koji se vodi na generator transakcija. Visok nivo na ovom signalu znači komandu čitanja _slave_ uređaja.                                                                                           |
| **wr_slv_o**        | out | std_logic                                 | Komandni signal koji se vodi na generator transakcija. Visok nivo na ovom signalu znači komandu pisanja u _slave_ uređaj.                                                                                          |
